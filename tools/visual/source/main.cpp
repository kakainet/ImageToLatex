...
int main(int argc, char* argv[])
{
    ...
    {
        logger->log(cst::system::wrong_args_size, itl::Logger::stream_t::console, itl::Logger::type_t::error);
        logger->log(cst::system::usage, itl::Logger::stream_t::console, itl::Logger::type_t::info);
    ...
    if(flag_manager->contains_flag(cst::flag::testing))
    {
        ...
        {
            logger->log(cst::gtest::fail_msg, itl::Logger::stream_t::console, itl::Logger::type_t::warning);
        }
    }
