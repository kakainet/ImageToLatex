...
namespace cst
{
    ...
    namespace gtest
    {
        ...
        constexpr char const* fail_msg = "Some unit tests failed. Program may not work correctly.";
    }
    ...
    namespace effect
    {
        ...
        constexpr char const* wrong_channel = "Failed during recognizing channel of input matrix";
    ...
    namespace manager
    {
        constexpr char const* loading_data_second_time = "Tried to load data second time";
    ...
    namespace thread
    {
        constexpr char const* fail_distr_worker = "Failed during distribution worker - there is no free worker.";
        constexpr char const* number_thread_info = "Program use multithreading. Threads number:";
    }
    ...
    namespace perlin
    {
        ...
        constexpr char const* missing_noise = "Missing noise. Program will recreate component with id ";
